...
enum SpecialEdition: String, Codable, CaseIterable, Identifiable {
    ...
    case zeroSugarCherryFloat = "Zero Sugar Cherry Float"
    ...
    var icon: String {
        ...
        case .zeroSugarCherryFloat: return "wineglass.fill"
        }
    }
    ...
    var badgeDescription: String {
        ...
        case .zeroSugarCherryFloat:
            return "Tasted the creamy cherry fountain dream of Zero Sugar Cherry Float."
        }
    }
