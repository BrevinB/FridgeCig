...
enum SpecialEdition: String, Codable, CaseIterable, Identifiable {
    ...
    case devilishLimeCherryChic = "Devilish Lime Cherry Chic"
    ...
    var icon: String {
        ...
        case .devilishLimeCherryChic: return "theatermasks.fill"
        }
    }
    ...
    var badgeDescription: String {
        ...
        case .devilishLimeCherryChic:
            return "Caught the AMC-exclusive Diet Coke Devilish Lime Cherry Chic at the movies."
        }
    }
