...
enum SpecialEdition: String, Codable, CaseIterable, Identifiable {
    ...
    case jamesBond007FirstLight = "007 First Light"
    ...
    var icon: String {
        ...
        case .jamesBond007FirstLight: return "film.fill"
        }
    }
    ...
    var badgeDescription: String {
        ...
        case .jamesBond007FirstLight:
            return "Sipped the 007 First Light Zero Sugar edition. Shaken, not stirred."
        }
    }
