...
enum SpecialEdition: String, Codable, CaseIterable, Identifiable {
    ...
    case marvelTheHeroes = "Marvel: The Heroes"
    ...
    var icon: String {
        ...
        case .marvelTheHeroes: return "bolt.shield.fill"
        }
    }
    ...
    var badgeDescription: String {
        ...
        case .marvelTheHeroes:
            return "Assembled the Marvel Universe one Coke Zero Sugar can at a time."
        }
    }
