...
enum SpecialEdition: String, Codable, CaseIterable, Identifiable {
    ...
    case cocaColaXStarWars = "Coca-Cola x Star Wars"
    ...
    var icon: String {
        ...
        case .cocaColaXStarWars: return "star.fill"
        }
    }
    ...
    var badgeDescription: String {
        ...
        case .cocaColaXStarWars:
            return "Sipped a galaxy far, far away with the Star Wars Zero Sugar collab."
        }
    }
